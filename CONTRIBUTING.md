# Contributing to @bakissation/satim-testing
...
```bash
git clone https://github.com/bakissation/satim-testing.git
cd satim-testing
npm install
npm run build
npm test
...
- On merge per channel: **`dev` → alpha**, **`staging` → beta**, **`main` → stable**. Notes go to [GitHub Releases](https://github.com/bakissation/satim-testing/releases).
